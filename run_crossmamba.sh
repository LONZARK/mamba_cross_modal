...
CUDA_VISIBLE_DEVICES=2 python main_avvp.py --mode train \
  ...
  --mamba_layers 1 \
  --cross True >./apr_output_logs/train_apr2_han_cmatt_to_cross_mamba.log
...
CUDA_VISIBLE_DEVICES=2 python main_avvp.py --mode test \
  ...
  --mamba_flag 'han cmatt to crossmamba' \
  --mamba_layers 1 \
  --cross True >./apr_output_logs/test_apr2_han_cmatt_to_cross_mamba.log
...
CUDA_VISIBLE_DEVICES=2 python main_avvp.py --mode train \
  ...
  --mamba_layers 1 \
  --cross True >./apr_output_logs/train_apr2_han_selfatt_to_cross_mamba.log
...
CUDA_VISIBLE_DEVICES=2 python main_avvp.py --mode test \
  ...
  --mamba_flag 'han selfatt to crossmamba' \
  --mamba_layers 1 \
  --cross True >./apr_output_logs/test_apr2_han_selfatt_to_cross_mamba.log
...
CUDA_VISIBLE_DEVICES=2 python main_avvp.py --mode train \
  ...
  --mamba_layers 1 \
  --cross True >./apr_output_logs/train_apr2_han_to_cross_mamba.log
...
CUDA_VISIBLE_DEVICES=2 python main_avvp.py --mode test \
  ...
  --mamba_flag 'only_crossmamba' \
  --mamba_layers 1 \
  --cross True >./apr_output_logs/test_apr2_han_to_cross_mamba.log
